...
CREATE TABLE IF NOT EXISTS conecta (
    centro CHAR(20),
    north_position CHAR(20),
    south_position CHAR(20),
    east_position CHAR(20),
    west_position CHAR(20),
    CONSTRAINT kkkpk PRIMARY KEY(centro) ,
    FOREIGN KEY (north_position) REFERENCES regiao(nome),
    FOREIGN KEY (south_position) REFERENCES regiao(nome),
    FOREIGN KEY (east_position) REFERENCES regiao(nome),
    FOREIGN KEY (west_position) REFERENCES regiao(nome)
);
