...
('Transição de floresta mágica', 'DESCRIÇÃO AQUI'),
('Entrada terreno ancião', 'DESCRIÇÃO AQUI'),
('Região de cultivo de plantas', 'DESCRIÇÃO AQUI'),
('Região de cultivo de plantas 2', 'DESCRIÇÃO AQUI'),
('Região de cultivo de plantas 3', 'DESCRIÇÃO AQUI'),
('Região de cultivo de plantas 4', 'DESCRIÇÃO AQUI'),
...
('Trilha de areia com altos indicativos', 'DESCRIÇÃO AQUI'),
('Trilha de areia com altos indicativos 2', 'DESCRIÇÃO AQUI'),
('Trilha de areia com altos indicativos 3', 'DESCRIÇÃO AQUI'),
('Trilha de areia com altos indicativos 4', 'DESCRIÇÃO AQUI'),
('Trilha de areia com altos indicativos 5', 'DESCRIÇÃO AQUI'),
('Trilha de areia com altos indicativos 6', 'DESCRIÇÃO AQUI'),
...
('transição da folha, areia e pedra', 'DESCRIÇÃO AQUI'),
('transição da folha, areia e pedra 2', 'DESCRIÇÃO AQUI'),
('transição da folha, areia e pedra 3', 'DESCRIÇÃO AQUI'),
('transição da folha, areia e pedra 4', 'DESCRIÇÃO AQUI'),
('transição da folha, areia e pedra 5', 'DESCRIÇÃO AQUI'),
('transição da folha, areia e pedra 6', 'DESCRIÇÃO AQUI'),
('Encontro das vilas da folha, areia,pedra', 'DESCRIÇÃO AQUI'),
...
('Pequena vila', 'Transição de floresta mágica', 'Densa floresta mágica 3', NULL, NULL),
('Transição de floresta mágica', 'Entrada terreno ancião', 'Pequena vila', NULL, NULL),
('Entrada terreno ancião', 'Região de cultivo de plantas', 'Transição de floresta mágica', NULL, NULL),
('Região de cultivo de plantas', 'Região de cultivo de plantas 2', 'Entrada terreno ancião', NULL, NULL),
('Região de cultivo de plantas 2', 'Região de cultivo de plantas 3', 'Região de cultivo de plantas', 'Região de cultivo de plantas 4', NULL),
('Região de cultivo de plantas 4', NULL, NULL, 'Travessia aquática especial', 'Região de cultivo de plantas 2'),
('Travessia aquática especial', NULL, NULL, 'Aposentos do Kabuto', 'Região de cultivo de plantas 4'),
...
('Região de cultivo de plantas 3', 'Região dos pântanos', 'Região de cultivo de plantas 2', NULL, NULL),
('Região dos pântanos', 'Região dos pântanos profunda', 'Região de cultivo de plantas 3', NULL, NULL),
...
('Entrada Vila da Areia', 'Terreno arenoso 2', 'Trilha de areia com altos indicativos', NULL, NULL),
('Trilha de areia com altos indicativos', 'Entrada Vila da Areia', 'Trilha de areia com altos indicativos 2', NULL, NULL),
('Trilha de areia com altos indicativos 2', 'Trilha de areia com altos indicativos', NULL, 'Trilha de areia comum', 'Trilha de areia com altos indicativos 3'),
('Trilha de areia com altos indicativos 3', NULL, NULL, 'Trilha de areia com altos indicativos 2', 'Trilha de areia com altos indicativos 4'),
('Trilha de areia com altos indicativos 4', 'Trilha de areia com altos indicativos 5', NULL, 'Trilha de areia com altos indicativos 3', NULL),
('Trilha de areia com altos indicativos 5', 'Trilha de areia com altos indicativos 6', 'Trilha de areia com altos indicativos 4', NULL, NULL),
('Trilha de areia com altos indicativos 6', 'Esconderijo de deidara', 'Trilha de areia com altos indicativos 5', NULL, NULL),
('Esconderijo de deidara', 'transição da folha, areia e pedra', NULL, NULL, NULL),
('transição da folha, areia e pedra', 'transição da folha, areia e pedra 2', 'Esconderijo de Deidara', NULL, NULL),
('transição da folha, areia e pedra 2', 'transição da folha, areia e pedra 3', 'transição da folha, areia e pedra', NULL, NULL),
('transição da folha, areia e pedra 3', NULL, 'transição da folha, areia e pedra 2', 'transição da folha, areia e pedra 4', 'transição da folha, areia e pedra 5'),
('transição da folha, areia e pedra 4', NULL, NULL, 'Saída floresta mágica', 'transição da folha, areia e pedra 5'),
('Saída floresta mágica', NULL, NULL, 'Densa floresta mágica', 'transição da folha, areia e pedra 4'),
...
('transição da folha, areia e pedra 5', NULL, NULL, 'transição da folha, areia e pedra 3', 'transição da folha, areia e pedra 6'),
('transição da folha, areia e pedra 6', NULL, NULL, 'transição da folha, areia e pedra 5', 'Encontro das vilas da folha, areia,pedra'),
('Encontro das vilas da folha, areia,pedra', 'Terreno de pedregulhos', NULL, 'transição da folha, areia e pedra 6', 'Região de pedregulhos úmidos'),
('Terreno de pedregulhos', 'Terreno de pedregulhos duros', 'Encontro das vilas da folha, areia,pedra', NULL, NULL),
...
('Região de pedregulhos úmidos', NULL, NULL, 'Encontro das vilas da folha, areia,pedra', 'Região de pedregulhos molhados'),
...
('Trilha de areia comum', NULL, NULL, 'Área comercial da vila da areia', 'Trilha de areia com altos indicativos 2'),
...
INSERT INTO loja(
  ...
  VALUES('Loja 1', 5, 2, 'Prédio governamental da folha');
